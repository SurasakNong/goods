...
<script> 
  ...
  function show_head(str1,str2,str3){  //========= ฟังก์ชั่นเพิ่ม    
      ...
      row1.innerHTML = `<th align="center" class="headTitle" colspan="6">รายงานรับเข้า (แยกรายการ)</th>`;
      row2.innerHTML = `<th colspan="6" align="center" class="headTitle2">${str1}</th>`;
      row3.innerHTML = `<th colspan="6" align="center" class="headTitle2">${str2} ${str3}</th>`;      
  }
  ...
  function show_dataTable(yy,ob){  //========= ฟังก์ชั่นเพิ่ม Row ตาราง    
    ...
    let n_col = 7; //==== จำนวน Column ที่แสดงทั้งหมด
    let col = [];
    ...
    if(ob.key_p == 'data'){ //=========== แสดงข้อมูลในตาราง ==================================
      ...
      col[5].innerHTML = `<div class="nm" align="left">`+ob.search+`</div>`;
      col[6].innerHTML = `<div class="nm" align="center">`+(ob.pcs*1).toFixed(0)+`</div>`;  
...
function ExportToExcel(type, fn, dl) {
  ...
  return dl ?
      ...
      XLSX.writeFile(wb, fn || ('ReceiveData_'+dd+'.' + (type || 'xlsx')));
}
